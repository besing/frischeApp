...
import CryptoJS from 'crypto-js'; // FIXME: Import neu eingefügt (komplette Zeile)

export default function digestAuthRequest(method, url, username, password) { // FIXME: Hier export eingefügt ( + andere Stellen auch(?) --> CryptoJS... / oder dieses JS von anderer Quelle (statt npm install)? )
